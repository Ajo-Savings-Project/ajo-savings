...
type ObjType = { message?: string | ZodIssue[] } & Record<string, unknown>
...
export const HTTP_STATUS_HELPER = {
  ...
  [HTTP_STATUS_CODE.BAD_REQUEST]: function (res: Response, obj: ObjType = {}) {
    res.status(HTTP_STATUS_CODE.BAD_REQUEST).json({
      message: 'Bad Request',
      ...obj,
    })
  },
  [HTTP_STATUS_CODE.UNAUTHORIZED]: function (res: Response, obj: ObjType = {}) {
    res
      .status(HTTP_STATUS_CODE.UNAUTHORIZED)
      .json({ message: "You don't have access to this resource.", ...obj })
  },
  [HTTP_STATUS_CODE.FORBIDDEN]: function (res: Response, obj: ObjType = {}) {
    res
      .status(HTTP_STATUS_CODE.FORBIDDEN)
      .json({ message: 'You are not allowed to make this request', ...obj })
  },
  [HTTP_STATUS_CODE.NOT_FOUND]: function (res: Response, obj: ObjType = {}) {
    res.status(HTTP_STATUS_CODE.NOT_FOUND).json({
      message: 'Not Found',
      ...obj,
    })
  },
  [HTTP_STATUS_CODE.CONFLICT]: function (res: Response, obj: ObjType = {}) {
    res.status(HTTP_STATUS_CODE.CONFLICT).json({ message: '', ...obj })
  },
  [HTTP_STATUS_CODE.SUCCESS]: function (res: Response, obj: ObjType = {}) {
